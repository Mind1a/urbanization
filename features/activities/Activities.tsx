      ...
      <section className="mx-auto w-[343px] py-6 md:w-[680px] xl:w-[1280px]">
        ...
        <div className="mt-[16px] flex w-[342px] flex-col gap-[8px] md:mt-[20px] md:w-[680px] md:gap-[16px] xl:mt-[36px] xl:w-[1280px]">
          <p className="text-[14px] leading-[20px] text-[#1E1E1E] md:text-[16px] md:leading-[28px] xl:text-[20px] xl:leading-[32px]">
            ...
            transformation and building upon the built - fundamentally
            challenges inherited notions of architectural production and
            authorial invention. In this lecture, Andreas Lechner examines the
            evolving relationship between architectural type, typology and
            strategies of transformation, drawing on his recent publication
            Architectural Affordances - Typologies of Umbau (2025).
          </p>
